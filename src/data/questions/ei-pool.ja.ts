...
export const eiPoolJa: Question[] = [
...

  {
    ...
    format: 'situation',
    locale: 'ja',
    content: '新しいプロジェクトのキックオフ会議で、\n自分の動き方は？',
    optionA: { text: '初対面の人にも\n積極的に話しかけて\n関係を作る', weight: 0.9 },
    optionB: { text: 'まず周りの\n様子を見て、\n雰囲気を\n掴んでから動く', weight: -0.7 },
    active: true,
    difficulty: 'easy',
...

  {
    ...
    locale: 'ja',
    content: '友人の結婚式の二次会で、\n知らない人ばかりの席に案内された',
    optionA: { text: '隣の人に\n自然と話しかけられる', weight: 1.0 },
    optionB: { text: '食事を進めながら、\n誰かが話しかけて\nくれるのを待つ', weight: -0.8 },
    active: true,
    difficulty: 'easy',
    tags: ['social', 'wedding'],
  },

  {
    ...
    locale: 'ja',
    content: '仕事終わりの夜、\n自由な時間が3時間ある',
    optionA: { text: '誰かを誘って\nご飯か飲みに行きたい', weight: 0.9 },
    optionB: { text: '家でゆっくり\n本や映画を楽しみたい', weight: -0.9 },
    active: true,
    difficulty: 'easy',
...

  {
    ...
    locale: 'ja',
    content: 'アイデアを練るとき、\nどちらが自然？',
    optionA: { text: '誰かと話しながら\n考えると整理される', weight: 0.9 },
    optionB: { text: '一人で考え込んでから\n人に話す', weight: -0.9 },
    active: true,
    difficulty: 'medium',
    tags: ['thinking', 'work'],
  },

  {
    ...
    locale: 'ja',
    content: '休日に予定が一日空いた',
    optionA: { text: '誰かを誘って\n外に出かけたくなる', weight: 0.9 },
    optionB: { text: '家で好きなことをして\n過ごせると嬉しい', weight: -0.9 },
    active: true,
    difficulty: 'easy',
...

  {
    ...
    locale: 'ja',
    content: '大事な決断について\n悩んでいるとき',
    optionA: { text: '何人かに相談して、\n話すうちに整理したい', weight: 0.8 },
    optionB: { text: '自分の中で\n考えがまとまるまで\n人には言わない', weight: -0.9 },
    active: true,
    difficulty: 'medium',
...

  {
    ...
    locale: 'ja',
    content: '大人数の集まりに\n2時間参加した後の気持ちは？',
    optionA: { text: 'もっと盛り上がりたい、\n二次会にも行きたい', weight: 1.0 },
    optionB: { text: '楽しかったけど、そろそろ\n一人の時間が欲しい', weight: -1.0 },
    active: true,
    difficulty: 'easy',
    tags: ['social', 'energy'],
  },
...

  {
    ...
    optionA: { text: 'その土地の人や\n旅人と交流したい', weight: 0.8 },
    optionB: { text: '知らない場所を\nひとりで歩く時間が好き', weight: -0.8 },
    active: true,
    difficulty: 'easy',
    tags: ['travel', 'leisure'],
  },
...

  {
    ...
    locale: 'ja',
    content: '新しい趣味を始めるなら、\nどんな形がいい？',
    optionA: { text: 'コミュニティや\nサークルに参加する形', weight: 0.8 },
    optionB: { text: 'ひとりで黙々と\n取り組める形', weight: -0.8 },
    active: true,
    difficulty: 'easy',
